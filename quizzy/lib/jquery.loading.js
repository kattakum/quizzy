...
;(function($) {
    ...
    $.extend(L, {
        ...
        on: function(l, force) {
            if (l.delay && !run) {
                ...
                return l.timeout = setTimeout(function() {// break
                    l.on.call(self, l, force);
                    delete l.timeout;
                }, l.delay);
            }
            l.parent = this;
            if (l.mask) l.mask = l.createMask.call(this, l);
            l.display = l.create.call(this, l);
            if (l.img) {
                l.initImg.call(this, l);
            } else if (l.element) {
                l.initElement.call(this, l);
            } else {
                l.init.call(this, l);
            }
            this.trigger('loadingStart', [l]);
        },
        initImg: function(l) {
            var self = this;
        ...
        pageBox: function(l) {
            var d = document, b = d.body, full = $.boxModel && l.css.position != 'fixed',
